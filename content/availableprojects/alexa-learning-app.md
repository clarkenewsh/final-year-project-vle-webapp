...
Explore and experiment (create) how an Alexa skill (app) can be used to aid uni cs student to
learn about a subject…. It needs to be much more than an audiobook style app. It needs
some interaction. ( http://glare2018.dei.unipd.it/talk/CIKM-GLARE-VoiceVsWeb_v2.pdf )
and (https://dl.acm.org/ft_gateway.cfm?id=2935386&type=pdf)
