...
// Feature: Tutor Create Example project
...
// sneario: Tutor Create Project example
...
// 10. Assert the p tag contains the text 'Tutor'
...
describe('Testing API GET, POST Endpoints - Creating a new project example', () => {
  ...
  // Functional Test
  it('Test GET Request - Creating a new project example', () => {
  ...
  it('Should visit the project examples page and check the newly created available project can be accessed and viewed', () => {
    // Given
    ...
    cy.get('p.author').should('contain', 'Author: Tutor') // 10.
